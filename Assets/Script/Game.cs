...
public class Game : MonoBehaviour
{
    ...
    public double JointTableProbability(string color, int DistanceFromGhost)
    {
        ...
        {
            if (color.Equals("yellow")) return 0.5;
            if (color.Equals("red")) return 0.05;
            if (color.Equals("green")) return 0.3;
            if (color.Equals("orange")) return 0.15;
        }
        
        if (DistanceFromGhost == 1 || DistanceFromGhost == 2)
        {
            if (color.Equals("yellow")) return 0.15;
            if (color.Equals("green")) return 0.05;
            if (color.Equals("orange")) return 0.5;
            if (color.Equals("red")) return 0.3;
        }

        if (DistanceFromGhost >= 5)
        {
            if (color.Equals("red")) return 0.05;
            if (color.Equals("green")) return 0.5;
            if (color.Equals("yellow")) return 0.3;
            if (color.Equals("orange")) return 0.15;
        }

        if(DistanceFromGhost == 0)
        {
            if (color.Equals("red")) return 0.7;
            if (color.Equals("yellow")) return 0.05;
            if (color.Equals("green")) return 0.05;
            if (color.Equals("orange")) return 0.2;
        }
